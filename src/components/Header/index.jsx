                ...
                <li className="relative group flex items-center gap-1 after:content-[''] after:bg-transparent after:block after:absolute after:top-[20px] after:left-0 after:w-full after:h-[30px]">
                  ...
                  <div className="w-[97.5vw] left-[-53vw] bg-white h-0  top-[4.5vw] px-[3vw]  overflow-hidden rounded-[1.5vw] absolute group-hover:h-[40vw]  ease-in-out transition-all duration-700 block bgblur ">
                    <div className="py-[5vw] flex justify-between gap-[2vw]">
                      ...
                      <Link href={"/solutions"} className="w-[18vw] flex flex-col  gap-[1vw]">
                     
                        <Image
                          src={"/assets/images/solutions/solutions-hero-img.png"}
                          height={310}
                          width={360}
                          alt="header-img"
                          className="rounded-[1.2vw] h-[50%]"
                        />
                        <div 
                  ...
                  >
                    <span className="relative link-line text-primary uppercase">Solutions</span>
                    <svg
                    ...
                    >
                      ...
                      <Link href={"/our-ips"} className="w-[18vw] flex flex-col gap-[1vw]">
                        <Image
                    ...
                    className={`cursor-pointer flex w-fit relative text-[1.1vw] gap-[0.7vw] group items-center mobile:gap-[2vw] tablet:text-[2.5vw] mobile:text-[4vw]  `}
                  >
                    <span className="relative link-line text-primary">IPs</span>
                    <svg
                      className="relative -rotate-[90deg] w-[1vw] h-[1vw] overflow-hidden mobile:w-[4vw] mobile:mt-[-1vw] mobile:h-[4vw] tablet:w-[2.5vw] tablet:h-[2.5vw]"
                      width="19"
                      height="23"
                    ...
                    >
                      ...
                      <Link href={"/school-of-digital"} className="w-[18vw] flex flex-col gap-[1vw]">
                        <Image
                          src={"/assets/images/schoolofdigital/school-of-digital-hero-img.png"}
                          height={310}
                          width={360}
                          alt="header-img"
                          className="rounded-[1.2vw] h-[50%]"
                    ...
                    className={`cursor-pointer flex w-fit relative text-[1.1vw] gap-[0.7vw] group items-center mobile:gap-[2vw] tablet:text-[2.5vw] mobile:text-[4vw]  `}
                  >
                    <span className="relative link-line text-primary uppercase">School of Digital</span>
                    <svg
                      className="relative -rotate-[90deg] w-[1vw] h-[1vw] overflow-hidden mobile:w-[4vw] mobile:mt-[-1vw] mobile:h-[4vw] tablet:w-[2.5vw] tablet:h-[2.5vw]"
                      width="19"
                      height="23"
