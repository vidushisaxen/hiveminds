    ...
    <>
      <section className="w-screen h-full py-[5%]" id="featured-blog">
        <div className="container-lg flex flex-col gap-[4vw] items-center mobile:items-start">
          <div className="flex flex-col items-center justify-center gap-[1vw] pb-[3vw] mobile:block mobile:space-y-[4vw] ">
            <h2 data-title-anim className="heading-2 headinganim">
              Featured <span className="blue-text"> Blog</span>
            </h2>
            <p className="content w-[60%] text-center fadein mobile:text-left mobile:w-full">
          ...
          <div className="w-full flex justify-between mobile:block mobile:space-y-[4vw]">
            <div className="w-[55%] h-[38vw] rounded-[1.5vw] overflow-hidden relative fadeup mobile:w-full mobile:h-[85vw] mobile:rounded-[4vw]">
              <Image
                ...
                height={620}
              />
              <span className="px-[1.5vw] py-[0.7vw] bg-white rounded-full absolute top-[5%] left-[5%] leading-[1] mobile:py-[2.5vw] mobile:px-[5vw]">Digital Marketing</span>
            </div>
            <div className="w-[40%] flex flex-col gap-[3.5vw] mt-[1vw] mobile:w-full mobile:!mt-[7vw] mobile:gap-[7vw]">
              <div className="flex flex-col gap-[0.7vw] mobile:gap-[5vw]">
                <h2 data-para-anim className="text-[3vw] font-medium leading-[1.1] mobile:text-[8.5vw]">
                  How to Setup Google Business Profile for Better Online
                  Presence in 2023
                </h2>
                <p className="fadein">6 June, 2024</p>
              </div>
              <p data-para-anim  className="w-[90%] mobile:w-full mobile:text-[4.5vw]">
