    ...
    <section id="contact">
      <div className="w-screen h-full z-[10] relative container-lg py-[7%] overflow-hidden">
        <div className="w-full h-full flex gap-[10vw] mobile:flex-col ">
          <div className="w-[45%] flex flex-col gap-[2vw] mobile:w-full mobile:flex-col mobile:gap-[5vw]">
            ...
            <div className='pt-[4vw] flex flex-col gap-[2vw] w-[50%] mobile:w-full mobile:gap-[5vw]'>
           <p data-para-anim className='text-[1.5vw] font-medium mobile:text-[5.5vw]'>Don&apos;t see any <span className='text-primary'>job opening</span> that might fit you?</p>
