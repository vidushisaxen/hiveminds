        ...
        <section className='h-full w-screen py-[5vw]'>
            <div className='w-full h-full container-lg'>
                <div className="flex flex-col items-center justify-center gap-[1vw] py-[5vw]">
                    ...
                    <p className="content w-[55%] text-center fadein">
                ...
                <div className='flex items-start justify-between py-[1vw]'>
                    ...
                    <Image src={img} height={890} width={790} className='rounded-[1.5vw]'/>
                    </div>
                    <div className='w-1/2 '>
                    <p className='text-[1.8vw] font-medium py-[2vw]'>We cultivate an environment that encourages creative problem-solving, continuous learning, and collaborative teamwork. Every voice is heard, and every idea is valued. Our diverse and inclusive community celebrates milestones together, supports personal growth, and drives digital transformation—making our workplace not only a hub for professional success but also a place where lifelong relationships are forged.</p>
