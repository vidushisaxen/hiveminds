...
const JobCard = ({title,duration,location,link}) => {
    return (
        <>
            <div className='w-[30vw] h-[25vw] shadow-xl drop-shadow-xl rounded-[1.5vw] flex flex-col items-start justify-between p-[2vw] bg-white fadeup mb-[1.5vw]'>
                <p className='text-[1.8vw]'>{title}</p>
                <span className='h-[1px] w-full bg-black my-[1vw]' />
...
const Jobs = () => {
    return (
        <section className='relative py-[5vw] w-screen h-full'>
            <div className='w-full h-full container-lg'>
                ...
                <div className='flex flex-wrap w-full h-full gap-[1vw] '>
                    <JobCard title={"Account Manager / Sr.Account Manager - SEM"} duration={"Full Tine"} location={"Bangalore"} link={"/"}/>
                    <JobCard  title={"Performance Marketing"} duration={"Full Tine"} location={"Bangalore"} link={"/"}/>
                    <JobCard  title={"Sr. Specialist - SEM"} duration={"Full Tine"} location={"Bangalore"} link={"/"}/>
                    <JobCard  title={"Account Manager / Sr.Account Manager - SEM"} duration={"Full Tine"} location={"Bangalore"} link={"/"}/>
                    <JobCard  title={"Specialist - Marketplace"} duration={"Full Tine"} location={"Bangalore"} link={"/"}/>
                    <JobCard  title={"Marketing Analyst"} duration={"Full Tine"} location={"Bangalore"} link={"/"}/>
                </div>
            </div>
