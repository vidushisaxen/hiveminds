  ...
  return (
    ...
    >
      <div className="w-full h-full container-lg flex  justify-between mobile:flex-col mobile:gap-[7vw] tablet:flex-col tablet:gap-[5vw]">
        ...
        <div className="w-[40%] h-[40vw] relative rounded-[1.2vw] overflow-hidden fadein mobile:w-full mobile:rounded-[4.5vw] mobile:h-[85vw] tablet:w-full tablet:h-[60vw] tablet:rounded-[3vw]">
          <Image
