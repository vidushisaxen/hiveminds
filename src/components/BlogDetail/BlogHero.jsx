      ...
      <div className="w-full h-full container-lg flex  justify-between mobile:flex-col mobile:gap-[7vw] tablet:flex-col tablet:gap-[5vw]">
        <div className="w-[45%] flex flex-col gap-[1vw] pt-[5vw] mobile:w-full mobile:gap-[4vw] tablet:w-full">
          ...
          <div
            ...
            className="content w-[88%] tracking-wide para mobile:w-full tablet:w-[90%] fadein"
          />
        </div>
        <div className="w-[40%] h-[40vw] rounded-[1.2vw] overflow-hidden fadein mobile:w-full mobile:rounded-[4.5vw] mobile:h-[85vw] tablet:w-full tablet:h-[60vw] tablet:rounded-[3vw]">
          <Image
