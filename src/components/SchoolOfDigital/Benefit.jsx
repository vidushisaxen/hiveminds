  ...
  <section className='h-full w-screen py-[5vw]'>
    <div className='w-full h-full container-lg'>
        ...
        <div className='flex items-center justify-between h-full mobile:mt-[10vw] mobile:flex-col mobile:gap-[10vw] '>
            <div className='flex flex-col items-center justify-center gap-[1.5vw] w-[30%] h-[20vw] mobile:flex mobile:flex-row mobile:justify-start mobile:w-full mobile:gap-[10vw]'>
                <Image src="/assets/icons/students.svg" height={100} width={100} alt='students' className='fadein'/>
                <p data-para-anim className='text-[1.5vw] font-medium mobile:text-[5vw]'>Students</p>
            </div>
            ...
            <div className='flex flex-col items-center justify-center gap-[1.5vw] w-[30%] h-[20vw]  mobile:flex mobile:flex-row mobile:justify-start mobile:w-full mobile:gap-[10vw]'>
                ...
                <p data-para-anim className='text-[1.5vw] font-medium w-[50%] text-center mobile:text-[5vw] mobile:text-left'>Entry & Mid Level Professionals</p>
            </div> 
            <span className='h-[20vw] w-[1px] bg-black mobile:h-[1px] mobile:w-full '/>

            <div className='flex flex-col items-center justify-center gap-[1.5vw] w-[30%] h-[20vw]  mobile:flex mobile:flex-row mobile:justify-start mobile:w-full mobile:gap-[10vw]'>
                <Image src="/assets/icons/mid-level.svg" height={100} width={100} alt='students' className='fadein'/>
                <p data-para-anim className='text-[1.5vw] font-medium w-[50%] text-center mobile:text-[5vw] mobile:text-left'>Mid to Senior Level Professionals</p>
            </div>
