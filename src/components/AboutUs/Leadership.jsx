  ...
  return (
    <>
      <section className="w-screen h-full py-[5vw] mobile:pt-8 mobile:pb-12">
        <div className="container-lg h-full flex items-center justify-center flex-col mobile:max-w-full">
          <div className="py-[1vw] w-[75%] text-center px-[1vw] mobile:w-full mobile:text-left mobile:px-[5vw]">
          ...
          <div>
            <div className="flex flex-col items-center justify-center gap-[1vw] py-[5vw] mobile:block mobile:py-8 mobile:px-[5vw]">
              <h2 className="heading-2 headinganim">
                Our
                <span className="blue-text"> Leadership</span>
              </h2>
              <p className="content w-[70%] text-center fadein mobile:w-full mobile:mt-5 mobile:text-left">
            ...
            <div className="mobile:w-screen mobile:overflow-hidden">
              <div className="flex justify-between flex-wrap w-full h-full py-[2vw] mobile:flex-nowrap mobile:overflow-x-auto mobile:gap-[5vw]">
                {team.map((team, id) => (
                  <div className="flex flex-col mb-[2vw] gap-[0.5vw] fadeup mobile:first:pl-[5vw] mobile:last-of-type:pr-[5vw] mobile:gap-4" key={id}>
                    <div className="w-[29.5vw] h-[33vw] rounded-[1.4vw] overflow-hidden bg-black mobile:w-[80vw] mobile:h-[90vw] mobile:rounded-[1.2rem]">
                      <Image
                        src={team.src}
                        alt={`${team.name} image`}
                        width={500}
                    ...
                    <div className="flex flex-col mobile:pl-2">
                      <h4 className="text-[1.6vw] mobile:text-lg leading-[1.2]">{team.name}</h4>
