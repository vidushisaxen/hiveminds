...
const Footer = () => {
  return (
    ...
    >
      <div className="w-screen h-[55vw] flex flex-col items-center justify-between bg-[#134BD6] pt-[3vw] pb-[2vw] gap-[0.5vw] fixed bottom-0 tablet:h-full tablet:static tablet:pt-20">
