...
const Footer = () => {
  return (
    <footer
      id="footer"
      className="w-screen h-[50vw] bg-transparent"
      style={{ clipPath: "polygon(0% 0, 100% 0%, 100% 100%, 0 100%)" }}
    >
      <div className="w-screen h-[50vw] flex flex-col items-center justify-between bg-[#134BD6] pt-[3vw] pb-[2vw] gap-[0.5vw] fixed bottom-0">
