...
const Footer = () => {
  return (
    <footer
      id="footer"
      className="w-screen h-[50vw] bg-transparent tablet:h-full"
      style={{ clipPath: "polygon(0% 0, 100% 0%, 100% 100%, 0 100%)" }}
    >
      <div className="w-screen h-[50vw] flex flex-col items-center justify-between bg-[#134BD6] pt-[3vw] pb-[2vw] gap-[0.5vw] fixed bottom-0 tablet:h-full tablet:static tablet:pt-20">
        <div className="w-full flex items-center justify-between gap-[10vw] text-white container-lg tablet:block tablet:space-y-16">
          <div className="w-[30%] h-full flex flex-col items-start justify-start gap-[2vw] tablet:w-full tablet:flex-row">
            ...
            <div className="h-[15vw] w-[25vw] relative rounded-[12px] tablet:w-2/5 tablet:h-[35vw] overflow-hidden tablet:mt-[6vw]">
              {/* <Map /> */}
              <Image src={"/assets/images/homepage/map.png"} alt="map" fill className="object-cover !static h-full w-full" />
            </div>
          </div>
          ...
          <div className="w-[55%] h-full flex flex-col items-start justify-start gap-[8vw] tablet:w-full">
            <div className="flex items-start justify-between w-full tablet:gap-4">
              <div className="space-y-[1.5vw]">
                ...
                <ul className="text-[1.05vw] text-white montreal font-medium flex flex-col items-start justify-center gap-[0.5vw] tablet:text-[2.2vw] tablet:gap-2">
                  <Link href={"/services/performance-marketing"} className="link-line">
                    {" "}
                    <li>Performance Marketing</li>
                  </Link>
                  <Link href={"/services/retail-marketing"} className="link-line">
                    {" "}
                    <li>Retail Marketing</li>
                  </Link>
                  <Link href={"/services/consumer-insights"} className="link-line">
                    <li>Consumer Insights</li>
                  </Link>
                  <Link href={"/services/influencer-marketing"} className="link-line">
                    <li>Influencer Marketing</li>
                  </Link>
                  <Link href={"/services/affiliate-marketing"} className="link-line">
                    <li>Affiliate Marketing</li>
                  </Link>
                  <Link href={"/services/data-analytic"} className="link-line">
                    <li>Data & Analytics</li>
                  </Link>
                  <Link href={"/services/social-media-marketing"} className="link-line">
                    <li>Programatic Advertising</li>
                  </Link>
                  <Link href={"/services/search-engine-optimization"} className="link-line">
                    <li>Search Engine Optimization</li>
                  </Link>
                  <Link href={"/services/creative-content-management"} className="link-line">
                    <li>Content Management & Creative
                    </li>
                  </Link>
                  <Link href={"/services/online-reputation-management"} className="link-line">
                    <li>Online Reputation Management</li>
                  </Link>
                  <Link href={"/services/branding"} className="link-line">
            ...
            <div className="flex w-full items-center justify-center tablet:items-start">
              ...
              <div className="w-full relative">
                ...
                <input
                  ...
                  className="w-[30vw] border-b-[1px] border-white bg-transparent mt-[0.5vw] tablet:mt-5 p-[0.5vw] pl-0 outline-none placeholder:text-white placeholder:text-[0.94vw] tablet:w-full tablet:placeholder:text-[2.5vw] tablet:text-[2.5vw]"
                />
