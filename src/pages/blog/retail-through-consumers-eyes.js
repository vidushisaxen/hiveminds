...
const content={
  ...
  content1:[
      ...
      "<p class='text-[2.5vw] mobile:text-[7vw] mobile:font-medium mobile:mt-[10vw]'>Shopping is No Longer Need-Based; The Retail Store is No Longer A Destination</p>",
  ...
  content2:[
    "<p class='text-[2.5vw] mobile:text-[7vw] mobile:font-medium mobile:mt-[10vw]'>Consumers are Willing To Be Part of the Product Journey.</p>",
      ...
      " <span class='bg-black w-[57%] h-[1.5px] absolute lineDraw mobile:hidden mobile:w-[92%] mobile:h-[1px] mobile:my-[4vw] my-[1vw]'/>",
      "<p class='text-[2.5vw] mobile:text-[7vw] mobile:font-medium mobile:mt-[10vw]'>Customers are Reincarnating Trends with Tech</p>",
  ...
  content3:[
    "<p class='text-[2.5vw] mobile:text-[7vw] mobile:font-medium mobile:mt-[10vw]'>Consumers Want “New,” “Better,” and “Crafted-For-Me” Products</p>",
