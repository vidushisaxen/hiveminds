...
const content={
  ...
  content2:[
    "<p class='text-[2.5vw] mobile:text-[7vw] mobile:font-medium mobile:mt-[10vw] tablet:text-[4.5vw]'>How do you select the right attribution window?</p>",
      ...
      "<p class='text-[2.5vw] mobile:text-[7vw] mobile:font-medium mobile:mt-[10vw] tablet:text-[4.5vw]'>A. How long is my business’s gestation period?</p>",
      ...
      "<p class='text-[2.5vw] mobile:text-[7vw] mobile:font-medium mobile:mt-[10vw] tablet:text-[4.5vw]'>B. Do I trust a particular channel to give it a shorter attribution frame? Does it even help?</p>",
  ...
  content3:[
    "<p class='text-[2.5vw] mobile:text-[7vw] mobile:font-medium mobile:mt-[10vw] tablet:text-[4.5vw]'>C. How would I manage different attribution windows of different channels? And how do I report these numbers?</p>",
