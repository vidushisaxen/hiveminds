...
const content={
  ...
  content1:[
      ...
      "<p class='text-[2.5vw]'>The Hiveminds Playbook: A Guide to D2C Success</p>",
  ...
  content2:[
    "<p class='text-[2.5vw]'>Series of insightful D2C Debates</p>",
      ...
      " <span class='bg-black w-[57%] h-[1.5px] absolute lineDraw my-[1vw]'/>",
      "<p class='text-[2.5vw]'>Fireside Chats: Real-World D2C Perspectives</p>",
  ...
  content3:[
    "<p class='text-[2.5vw]'>Key Takeaways and D2C Success</p>",
      ...
      " <span class='bg-black w-[57%] h-[1.5px] absolute lineDraw my-[1vw]'/>",
      "<p class='text-[2.5vw]'>Hiveminds: Your D2C Partner</p>",
