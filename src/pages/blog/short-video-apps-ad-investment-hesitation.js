...
const content={
  ...
  content1:[
      ...
      "<p class='text-[2.5vw]'>What are players saying?</p>",
  ...
  content2:[
    "<p class='text-[2.5vw]'>Not trending anymore?</p>",
  ...
  content3:[
    "<p class='text-[2.5vw]'>Effect on creator economy</p>",
      ...
      " <span class='bg-black w-[57%] h-[1.5px] absolute lineDraw my-[1vw]'/>",
      "<p class='text-[2.5vw]'>The Future</p>",
