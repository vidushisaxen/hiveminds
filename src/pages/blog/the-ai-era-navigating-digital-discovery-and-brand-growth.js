...
const content={
  ...
  content2:[
    "<p class='text-[2.5vw]'>The germination</p>",
      ...
      " <span class='bg-black w-[57%] h-[1.5px] absolute lineDraw my-[1vw]'/>",
      "<p class='text-[2.5vw]'>Expanding in the Middle East and the West</p>",
  ...
  content3:[
    "<p class='text-[2.5vw]'>Anticipating digital marketing trends</p>",
