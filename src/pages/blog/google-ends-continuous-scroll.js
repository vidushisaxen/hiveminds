...
const content={
  ...
  content1:[
      ...
      "<p class='text-[2.5vw]'>Why, What , How?</p>",
  ...
  content3:[
      "<p class='content'>“Whether that will happen or not is still debatable, but with the discontinuation of the feature, appearing on top of the first page becomes crucial. Paid ads will play a significant role just as it was doing before,” says Chaki.</p>",
