...
const content={
  ...
  content2:[
    "<p class='text-[2.5vw] mobile:text-[7vw] mobile:font-medium mobile:mt-[10vw] tablet:text-[4.5vw]'>The challenges women entrepreneurs face in India </p>",
      ...
      " <span class='bg-black w-[57%] h-[1.5px] absolute lineDraw  mobile:hidden mobile:w-[92%] mobile:h-[1px] mobile:my-[4vw] my-[1vw] tablet:h-[1px] tablet:w-[92%]'/>",
      "<p class='text-[2.5vw] mobile:text-[7vw] mobile:font-medium mobile:mt-[10vw] tablet:text-[4.5vw]'>Second innings for women entrepreneurs after their sabbatical break</p>",
  ...
  content3:[
    "<p class='text-[2.5vw] mobile:text-[7vw] mobile:font-medium mobile:mt-[10vw] tablet:text-[4.5vw]'>Becoming a successful women entrepreneur</p>",
