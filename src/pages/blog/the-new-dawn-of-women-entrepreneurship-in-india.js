...
const content={
  ...
  content2:[
    "<p class='text-[2.5vw]'>The challenges women entrepreneurs face in India </p>",
      ...
      " <span class='bg-black w-[57%] h-[1.5px] absolute lineDraw my-[1vw]'/>",
      "<p class='text-[2.5vw]'>Second innings for women entrepreneurs after their sabbatical break</p>",
  ...
  content3:[
    "<p class='text-[2.5vw]'>Becoming a successful women entrepreneur</p>",
