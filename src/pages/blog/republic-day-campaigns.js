...
const content={
  ...
  content2:[
    "<p class='text-[2.5vw] mobile:text-[7vw] mobile:font-medium mobile:mt-[10vw] tablet:text-[4.5vw]'>Naila Patel, Sr. Vice President and National Creative Director, Mirum India:</p>",
      ...
      "<p class='text-[2.5vw] mobile:text-[7vw] mobile:font-medium mobile:mt-[10vw] tablet:text-[4.5vw]'>Ramanuj Shastry, Creative Chairman, Infectious Advertising: </p>",
      "<p class='text-[1.5vw] !font-medium tablet:text-[3vw]'>Dos</p>",
      "<p class='content'><ul class='list-decimal space-y-[0.5vw] tablet:space-y-[3vw] px-[1vw] tablet:px-[2vw]'><li>Be patriotic tastefully: Be respectful and authentic in your messaging.</li><li>Borrow from culture: Use Insights, music and visual language that showcase our rich heritage.</li><li>Align values: Align your brand message with positive values associated with Republic Day.</li></ul></p>",
       "<p class='text-[1.5vw] !font-medium tablet:text-[3vw]'>Don'ts</p>",
      "<p class='content'><ul class='list-decimal space-y-[0.5vw] px-[1vw] tablet:px-[2vw] tablet:space-y-[3vw]'><li>Avoid commercialization: Steer clear of verbiage that feels opportunistic.</li><li>Avoid trivializing: Ensure that the advertising doesn't disrespect the significance of the occasion. </li><li>Stay apolitical: Avoid political topics or comments.</li></ul></p>",
      " <span class='bg-black w-[57%] h-[1.5px] absolute lineDraw  mobile:hidden mobile:w-[92%] mobile:h-[1px] mobile:my-[4vw] my-[1vw] tablet:h-[1px] tablet:w-[92%]'/>",
      "<p class='text-[2.5vw] mobile:text-[7vw] mobile:font-medium mobile:mt-[10vw] tablet:text-[4.5vw]'>Deepti Bhadauria, Chief Strategy Officer, HiveMinds: </p>",
      ...
      "<p class='text-[1.5vw] !font-medium tablet:text-[3vw]'>Dos</p>",
      "<p class='content'><ul class='list-decimal space-y-[0.5vw] tablet:space-y-[3vw] px-[1vw] tablet:px-[2vw]'><li>Celebrate the National event for what it stands for – Pride, unity and sovereignty</li><li>Engage with your users with interesting questions, trivia quizzes etc.</li><li>For impulse categories, long weekends and Republic Day holidays can be opportunities to conduct a tactical campaign for online sales or store walk-ins.</li><li>Use your social media to share how your brand and internal teams are celebrating the event to keep it real.</li></ul></p>",
       "<p class='text-[1.5vw] !font-medium tablet:text-[3vw]'>Don'ts</p>",
      "<p class='content'><ul class='list-decimal space-y-[0.5vw] tablet:space-y-[3vw] px-[1vw] tablet:px-[2vw]'><li>Do not use the National holiday only for a sales campaign, find the right integration with your brand. For categories that are high involvement purchases and involve long research and compare periods, Republic Day tactical campaigns might not work.</li><li>Do not shift focus from the main event, it is important to keep the narrative right, such as which year we are celebrating, etc.</ul></p>",
      " <span class='bg-black w-[57%] h-[1.5px] absolute lineDraw  mobile:hidden mobile:w-[92%] mobile:h-[1px] mobile:my-[4vw] my-[1vw] tablet:h-[1px] tablet:w-[92%]'/>",
      "<p class='text-[2.5vw] mobile:text-[7vw] mobile:font-medium mobile:mt-[10vw] tablet:text-[4.5vw]'>Mukund Olety, Chief Creative Officer, VML India:</p>",
      ...
      " <span class='bg-black w-[57%] h-[1.5px] absolute lineDraw  mobile:hidden mobile:w-[92%] mobile:h-[1px] mobile:my-[4vw] my-[1vw] tablet:h-[1px] tablet:w-[92%]'/>",
      "<p class='text-[2.5vw] mobile:text-[7vw] mobile:font-medium mobile:mt-[10vw] tablet:text-[4.5vw]'>Moumita Pal, Head of Creative, Enormous:</p>",
      ...
      " <span class='bg-black w-[57%] h-[1.5px] absolute lineDraw  mobile:hidden mobile:w-[92%] mobile:h-[1px] mobile:my-[4vw] my-[1vw] tablet:h-[1px] tablet:w-[92%]'/>",
      "<p class='text-[2.5vw] mobile:text-[7vw] mobile:font-medium mobile:mt-[10vw] tablet:text-[4.5vw]'>Jagdish Acharya, Founder & Creative Head, Cut The Crap:</p>",
      ...
      " <span class='bg-black w-[57%] h-[1.5px] absolute lineDraw  mobile:hidden mobile:w-[92%] mobile:h-[1px] mobile:my-[4vw] my-[1vw] tablet:h-[1px] tablet:w-[92%]'/>",
      "<p class='text-[2.5vw] mobile:text-[7vw] mobile:font-medium mobile:mt-[10vw] tablet:text-[4.5vw]'>Rahul Mathew, Chief Creative Officer, DDB Mudra Group:</p>",
      ...
      " <span class='bg-black w-[57%] h-[1.5px] absolute lineDraw  mobile:hidden mobile:w-[92%] mobile:h-[1px] mobile:my-[4vw] my-[1vw] tablet:h-[1px] tablet:w-[92%]'/>",
      "<p class='text-[2.5vw] mobile:text-[7vw] mobile:font-medium mobile:mt-[10vw] tablet:text-[4.5vw]'>Mayank Vora, Co-Founder & Director, Logicloop:</p>",
  ...
  content3:[
    "<p class='text-[2.5vw] mobile:text-[7vw] mobile:font-medium mobile:mt-[10vw] tablet:text-[4.5vw]'>Jasmine Shah, Assistant Manager Client Servicing, BC WEB WISE:</p>",
