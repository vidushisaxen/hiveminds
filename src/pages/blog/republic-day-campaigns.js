...
const content={
  ...
  content2:[
    "<p class='text-[2.5vw]'>Naila Patel, Sr. Vice President and National Creative Director, Mirum India:</p>",
      ...
      "<p class='text-[2.5vw]'>Ramanuj Shastry, Creative Chairman, Infectious Advertising: </p>",
      ...
      " <span class='bg-black w-[57%] h-[1.5px] absolute lineDraw my-[1vw]'/>",
      "<p class='text-[2.5vw]'>Deepti Bhadauria, Chief Strategy Officer, HiveMinds: </p>",
      ...
      " <span class='bg-black w-[57%] h-[1.5px] absolute lineDraw my-[1vw]'/>",
      "<p class='text-[2.5vw]'>Mukund Olety, Chief Creative Officer, VML India:</p>",
      ...
      " <span class='bg-black w-[57%] h-[1.5px] absolute lineDraw my-[1vw]'/>",
      "<p class='text-[2.5vw]'>Moumita Pal, Head of Creative, Enormous:</p>",
      ...
      " <span class='bg-black w-[57%] h-[1.5px] absolute lineDraw my-[1vw]'/>",
      "<p class='text-[2.5vw]'>Jagdish Acharya, Founder & Creative Head, Cut The Crap:</p>",
      ...
      " <span class='bg-black w-[57%] h-[1.5px] absolute lineDraw my-[1vw]'/>",
      "<p class='text-[2.5vw]'>Rahul Mathew, Chief Creative Officer, DDB Mudra Group:</p>",
      ...
      " <span class='bg-black w-[57%] h-[1.5px] absolute lineDraw my-[1vw]'/>",
      "<p class='text-[2.5vw]'>Mayank Vora, Co-Founder & Director, Logicloop:</p>",
  ...
  content3:[
    "<p class='text-[2.5vw]'>Jasmine Shah, Assistant Manager Client Servicing, BC WEB WISE:</p>",
