...
const content={
  ...
  content2:[
    "<p class='text-[2.5vw]'>Initial days</p>",
      ...
      " <span class='bg-black w-[57%] h-[1.5px] absolute lineDraw my-[1vw]'/>",
      "<p class='content !font-medium'>As of 2016, Intutel was built as a decision intelligence tool that helped companies make decisions on the right kind of marketing based on data.</p>",
      ...
      "<p class='text-[2.5vw]'>Digital focus</p>",
      ...
      " <span class='bg-black w-[57%] h-[1.5px] absolute lineDraw my-[1vw]'/>",
      "<p class='text-[2.5vw]'> Number crunching</p>",
      ...
      " <span class='bg-black w-[57%] h-[1.5px] absolute lineDraw my-[1vw]'/>",
      "<p class='text-[2.5vw]'> Crossroads dilemma</p>",
  ...
  content3:[
    "<p class='text-[2.5vw]'>  Collaborating now</p>",
    ...
    " <span class='bg-black w-[57%] h-[1.5px] absolute lineDraw my-[1vw]'/>",
    "<p class='text-[2.5vw]'>Magic words</p>",
