...
const content={
  ...
  content1:[
    "<p class='text-[2.5vw]'> To cut a long story short…or not?</p>",
  ...
  content2:[
    "<p class='text-[2.5vw]'>Keeping the story ‘real’</p>",
      ...
      "<p class='text-[2.5vw]'>Leveraging technology for Storytelling</p>",
  ...
  content3:[
    "<p class='text-[2.5vw]'>Make (them) believe the story</p>",
