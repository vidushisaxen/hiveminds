...
const ips = () => {
    ...
    return (
        <>
            <Layout>
                <Hero title1={"Our"} title2={"IPs"} para={"SEO is vastly interdisciplinary and it requires skills ranging from coding to linguistics to production. It includes services such as Influencer Marketing and Organic Social Media Management."} img={"/assets/images/industry/industry-hero.png"} />
                <main>
                    ...
                    <section className='w-screen h-full py-[2vw]'>
        ...
        ${index % 2 !== 0 ? 'mt-[8vw]' : ''}`}
                                >
                                    <div className='h-[40vw] pb-[2vw]'>
                                        <Image src={item.img} width={790} height={1090} alt="service-card" className='rounded-[1.2vw] fadein w-full h-full object-cover' />
                                    </div>
                                    <div>
