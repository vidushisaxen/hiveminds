...
const content = {
    ...
    features:[
        "<p class='text-[1.5vw] py-[1vw]'><span class='text-primary'>100% </span> CTR Growth</p>",
        "<p class='text-[1.5vw] py-[1vw]'><span class='text-primary'>50% </span> Higher Conversions</p>",
        "<p class='text-[1.5vw] py-[1vw]'><span class='text-primary'> Top 3 </span> Rank (Sept 2022)</p>",
