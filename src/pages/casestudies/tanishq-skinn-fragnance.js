...
const content = {
    ...
    intro: "<p class='mobile:mt-[7vw] mt-[2vw]'>Festive campaign sparks fragrance revolution. </p>",
    features:[
        "<p class=' py-[1vw]'> <span class='text-primary'> 15.7M </span>  Reach in 1 Month</p>",
        "<p class=' py-[1vw]'> <span class='text-primary'> 43% </span> Rise in Branded Search Volume</p>",
    ...
    problem: " <p class=' mt-[2vw]'>Skinn by Titan needed to build awareness and secure market space in the competitive perfume industry during the festive season, while driving new buyer influx.</p>",
    ...
    impact: "<p class=' mt-[2vw]'>Delivered <span class='text-primary'> 15.7M</span> reach in one month and achieved a <span class='text-primary'> 43%</span>, increase in branded search volume, marking record engagement."
}
