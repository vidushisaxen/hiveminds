...
const content = {
    ...
    intro: "<p class='mobile:mt-[7vw] mt-[2vw]'>Affordable stays drive 96% booking surge. <br/><br/>GHA Discovery sees unmatched growth with a 96% increase in bookings under $120 in just 3 months with affordable stays. </p>",
    features:[
        "<p class=' py-[1vw]'><span class='text-primary'> 96% </span> Increase in Bookings Under $120 (3 Months)</p>",
    ],
    industry: "Travel & Tourism",
    service: "PPC",
    category: "Incremental Bookings",
    problem: " <p class='mt-[2vw]'>GHA Discovery needed to garner incremental bookings without inflating cost per booking, ensuring sustained market growth in a competitive travel landscape.</p>",
    approach: "<p class=' mt-[2vw]'>Our approach focused on three key pillars. First, we targeted high-performing locations by deploying a full-funnel strategy—from app installs and sign-ups to website traffic and bookings—ensuring we reached high-intent users. <br/><br/> Second, we optimized our channel mix using platforms such as Google Search, PMax, VAC, Discovery, UAC, and Meta to maximize incremental bookings. <br/><br/>Finally, we drove engagement by promoting exclusive offers and flash sales, reinforcing GHA Discovery’s unique value proposition.</p>",
    impact: "<p class=' mt-[2vw]'>The campaign drove a <span class='text-primary !font-medium'> 96% increase </span> in bookings under $120 over 3 months, with October emerging as the best performing month, significantly boosting GHA Discovery's market share.</p>"
