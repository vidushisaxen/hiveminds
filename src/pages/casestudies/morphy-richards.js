...
const content = {
    ...
    intro: "<p class='mobile:mt-[7vw] mt-[2vw]'>10x growth redefines grooming market.<br/><br/>Morphy Richards redefines the personal grooming market with 10x growth in just 2 months. </p>",
    features:[
        "<p class=' py-[1vw]'><span class='text-primary'> 10x </span>  growth in 2 months</p>",
        "<p class=' py-[1vw]'><span class='text-primary'> 4% </span>  market share in 4 months</p>",

    ],
    industry: "Electronics & Consumer Durables",
    service: "Marketplace",
    category: "Product Launch on Ecommerce",
    problem: " <p class=' mt-[2vw]'>Morphy Richards aimed to penetrate the personal grooming market via ecommerce channels; however, its legacy as a kitchen appliances brand and fierce competition posed significant challenges.</p>",
    ...
    impact: "<p class=' mt-[2vw]'>Achieved a <span class='text-primary !font-medium'> 10x growth </span>rin brand business within 2 months, capturing 4% market share in 4 months and establishing Morphy Richards as a leader in personal grooming.</p>"
