...
const content = {
    ...
    subtitle2: "Surge",
    intro: "<p class='mobile:mt-[7vw] mt-[2vw]'>Smart campaigns drive store walk-ins. </p>",
    features:[
        "<p class=' py-[1vw]'> <span class='text-primary'> 63,000</span> Store Walk-ins; RoAS <span class='text-primary'>667X</span></p>",
      
    ],
    industry: "Fashion & Lifestyle",
    service: "Branding",
    category: "Improved Sales Share on Amazon US and India",
    problem: " <p class=' mt-[2vw]'>Tanishq needed to create strong awareness and drive store visits, converting digital interactions into tangible in-store footfall amid competitive market challenges.</p>",
    ...
    impact: "<p class=' mt-[2vw]'>Users were directed to nearby store listings, resulting in <span class='text-primary'> 63,000</span> walk-ins with a RoAS of <span class='text-primary'>667X</span>, proving the effectiveness of our targeted in-store awareness strategy.</p>"
