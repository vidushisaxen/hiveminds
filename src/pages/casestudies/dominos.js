...
const content = {
    ...
    intro: "<p class='mobile:mt-[7vw] mt-[2vw]'>Influencer partnerships fuel scalable order growth.<br/><br/> Dominoes driving success with 500K+ new orders in 12 months.  </p>",
    features:[
        "<p class=' py-[1vw]'><span class='text-primary'> 500K+ </span> New Orders in 12 Months</p>",
        "<p class=' py-[1vw]'><span class='text-primary'> High </span> Conversion Rates Achieved</p>",

    ],
    industry: "E-Commerce",
    service: "Affiliates / Influencers",
    category: "Affiliates ",
    problem: " <p class=' mt-[2vw]'>Domino’s experienced stagnant online order growth as traditional channels failed to convert digital traffic, hindering sales despite a robust product portfolio.</p>",
    ...
    impact: "<p class=' mt-[2vw]'>Achieved over 500K orders, onboarded <span class='text-primary !font-medium'> 15K+ </span> influencers, and delivered <span class='text-primary !font-medium'> 500K+ </span> premium app installs, fueling transformative digital engagement and accelerating global performance growth. </p>"
